      ...
      <div className="pt-16">
        <div className="container mx-auto p-4 max-w-4xl">
          <div className="mb-6">
            ...
            <p className="text-muted-foreground">Get help with your hosting experience</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent>
                <Button className="w-full bg-success hover:bg-success/90">Start Chat</Button>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Browse hosting guides and tips</CardDescription>
              </CardHeader>
              <CardContent>
                <Button variant="outline" className="w-full bg-transparent">
